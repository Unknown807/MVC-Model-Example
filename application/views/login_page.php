...
<form class="container" style="margin-top:30px" action=<?php echo site_url("user/doLogin")?> method="post">
    <h2>Enter Your Details</h2>

    <div class="row">
        <div class="col form-group">
            <label for="usernameInput">Username</label>
            <input type="text" class="form-control" name="usernameInput" aria-describedby="usernameError" placeholder="Enter username" value="<?php echo $username_val ?>"/>
            <small id="usernameError" class="form-text text-danger"><?php echo $username_error_text ?></small>
	    </div>
    </div>
    ...
    <div class="row">
	  <div class="col form-group">
          ...
          <input type="password" class="form-control" name="passwordInput" aria-describedby="passwordError" placeholder="Enter password" />
          <small id="passwordError" class="form-text text-danger"><?php echo $password_error_text ?></small>
	  </div>
    </div>
