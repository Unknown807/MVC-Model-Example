...
<form class="container" style="margin-top:30px" action=<?php echo site_url("search/doSearch")?> method="get">
    <h2>Search Posts</h2>
    <div class="row">
        <div class="col form-group">
            <input class="form-control" value="<?php echo $search_term ?>" type="text" aria-describedby="searchError" name="searchInput" placeholder="Search user posts..." />
            <small id="searchError" class="form-text text-danger"><?php echo $error_text ?></small>
        </div>
        <div>
